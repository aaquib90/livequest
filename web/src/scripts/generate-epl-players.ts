...
function parseMarkdownTable(md: string): PlayerRow[] {
...
function dedupeRows(rows: PlayerRow[]): PlayerRow[] {
...
function main() {
  ...
  if (!inputPath) {
    console.error("Usage: tsx src/scripts/generate-epl-players.ts <absolute-path-to-md>");
    process.exit(1);
  }
