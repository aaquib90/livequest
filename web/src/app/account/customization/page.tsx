        ...
        <Card className="border-border/70 bg-background/50">
          <CardHeader>
            ...
            <CardDescription className="text-base">
              Choose your global accent, card silhouette, and surface finish. Changes apply to embeds
              immediately.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form action={updateBrandingTheme} className="space-y-5" aria-label="Base theme settings">
              <div className="space-y-2">
                ...
                <Select id="palettePreset" name="palettePreset" defaultValue={selectedPreset}>
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-muted-foreground">
                  Provide a hex value (e.g. #0EA5E9) to override the {selectedPresetName} preset. Leave
                  blank to stick with the preset accent.
                </p>
              </div>
          ...
          <CardContent className="space-y-4">
            <div className={previewCardClass} style={previewCardStyle}>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Buttons, badges, and scorelines will inherit your accent color so the experience stays on
                brand everywhere.
              </p>
            ...
            <div className="rounded-2xl border border-dashed border-border/60 bg-background/60 p-4">
              <p className="text-sm text-muted-foreground">
                Coming soon: preview any liveblog, toggle between dark/light, and test device breakpoints
          ...
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              {!canUsePremiumThemes ? (
                <Badge
                  variant="muted"
                  className="mb-4 border border-primary/40 bg-primary/10 text-primary"
                >
                  Pro
                </Badge>
              ) : null}
            ...
            <CardDescription className="text-base">
              Store artwork once and we&apos;ll thread it through embeds, newsletters, and share cards
              automatically.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {canUsePremiumThemes ? (
              <form action={updateBrandAssets} className="space-y-5" aria-label="Premium branding settings">
                ...
                />
                <p className="text-xs text-muted-foreground">
                  Assets are stored in <code>brand-assets/{branding.account_id}</code>. Reuse paths across liveblogs
                  or swap them out per event as needed.
                </p>
                <div className="space-y-2">
              ...
              <div className="space-y-4 rounded-2xl border border-dashed border-primary/40 bg-primary/5 p-6 text-sm text-muted-foreground">
                ...
                <p>
                  Paid plans unlock logo uploads, custom backgrounds, and per-event overrides. Your audience
                  will see your brand—not ours.
                </p>
        ...
        {canUsePremiumThemes ? (
          <Card className="border-border/70 bg-background/50">
            <CardHeader>
              ...
              <CardDescription className="text-base">
                Your plan supports logos, backgrounds, and watermarking. We&apos;ll reach out ahead of the
                asset uploader beta.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4 text-sm text-muted-foreground">
              ...
              <p>
                Need bespoke presets or newsroom-wide overrides? Let us know and we&apos;ll prioritise it for
                the beta.
              </p>
            </CardContent>
          </Card>
